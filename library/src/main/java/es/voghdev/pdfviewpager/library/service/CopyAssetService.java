...
public class CopyAssetService extends IntentService {
    private static final String ACTION_COPY_ASSET = BuildConfig.LIBRARY_PACKAGE_NAME + ".copy_asset";

    private static final String EXTRA_ASSET = BuildConfig.LIBRARY_PACKAGE_NAME + ".asset";
    private static final String EXTRA_DESTINATION = BuildConfig.LIBRARY_PACKAGE_NAME + ".destination_path";
